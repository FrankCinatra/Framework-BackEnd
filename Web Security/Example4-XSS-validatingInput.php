...
<body>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      Name:
      <span style="color: red">*<?php echo $name_error_msg;?></span><br>
      <input type="text" name="name" value="<?php echo $name;?>"><br><br>

      Email:
      <span style="color: red">*<?php echo $email_error_msg;?></span><br>
      <input type="text" name="email" value="<?php echo $email;?>"><br><br>

      Phone number:
      <span style="color: red">*<?php echo $phone_error_msg;?></span><br>
      <input type="text" name="phone" value="<?php echo $phone;?>"><br><br>

      Property Type:
      <span style="color: red">*<?php echo $property_error_msg;?></span><br>
