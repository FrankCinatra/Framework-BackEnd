...
<body style="font-family: sans-serif;">
  <?php
    ...
    function getDatabaseConnection() {
      ...
      $username = "root"; //tenia usuario: janani
      $password = ""; //tenia password: password
      $dbName = "WebSecurity";
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    Email address:<br>
    <input type="text" name="user_email" maxlength="100"><br><br>

    Password:<br>
    <input type="text" name="user_password" maxlength="20"><br><br>
